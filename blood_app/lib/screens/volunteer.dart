...
class Volunteer extends StatefulWidget {
  ...
  @override
  State<Volunteer> createState() => _AdduserState();
}

class _AdduserState extends State<Volunteer> {
  ...
  Future<void> _submitData() async {
    if (_formkey.currentState!.validate()) {
      try {
        ...
        _showToast('Donor added successfully');
        Navigator.pop(context);
      } catch (e) {
        _showToast('Failed to add donor: $e');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 1, 19, 47),
